		...
		<div class="col-md-4 world">
			...
			<div class="col-md-4 header-left">		
					...
					<div class="cart box_1">
						...
						<p><a href="/design/checkout.jsp" class="simpleCart_empty">查看购物车t</a></p>
...
<div class="products">
	<div class="container">
		...
		<div align="center">
				...
				<a href="${ctx }/page/get?pageNum=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ctx }/page/get?pageNum=${page.getPrePageNum() }">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ctx }/page/get?pageNum=${page.getNextPageNum() }">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ctx }/page/get?pageNum=${page.totalPageNum }">末页</a>	  
	  		</div>	
<!--//menu-->
<!--seller-->
